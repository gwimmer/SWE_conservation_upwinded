...
simulation, with non-energy conserving space discretisation including
...
if COMM_WORLD.Get_rank() == 0:
    print("Simulation for Williamson5 test case, model Non_Var", "\n",
...
# u forcing solver
u_f = div(w)*Prhs*dx - f*inner(perp(u_rec), w)*dx
